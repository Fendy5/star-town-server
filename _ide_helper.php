...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function accepted($data = null, $message = '', $location = '')
        {
         ...
         * @static 
         */ 
        public static function created($data = null, $message = '', $location = '')
        {
                        /** @var \Jiannei\Response\Laravel\Response $instance */
         ...
         *
         * @param \Illuminate\Http\Resources\Json\JsonResource|array|null|mixed $data
         * @param string $message
         * @param int $code
         * @param array $headers
         * @param int $option
         ...
         * @static 
         */ 
        public static function success($data = null, $message = '', $code = 200, $headers = [], $option = 0)
        {
                        /** @var \Jiannei\Response\Laravel\Response $instance */
